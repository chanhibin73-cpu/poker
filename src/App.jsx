...
export default function App() {
  ...
  // ★ ランク戦のロビー待機時にAIが1人ずつ自動参加してくるタイマー処理
  useEffect(() => {
    if (
      currentScreen === "lobby" &&
      roomData &&
      ...
      }, 1500 + Math.random() * 1000); // 1.5秒〜2.5秒ごとに1人追加
  ...
  // ★ 対戦開始ロジック（満員でない場合はその場で残りのAIを補充して開始）
